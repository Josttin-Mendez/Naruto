...
class Game:
    ...
    def show_menu(self):
        ...
        if self.death_count == 0:
            draw_message_component("Press any key to start", self.screen, pos_y_center = half_screen_height + 100)
            self.screen.blit(ICON, (half_screen_width - 80, half_screen_height - 100))
        else:
            draw_message_component("Press any key to restart the game", self.screen, pos_y_center = half_screen_height + 140)
            self.screen.blit(ICON, (half_screen_width - 80, half_screen_height - 100))
            draw_message_component(
